...
public class AuthFilter implements Filter {
    ...
    static {
        /*
         * Mapa usuario_tomcat -> (dni, password) de CentroEducativo.
         * El usuario de Tomcat (clave del map y j_username) coincide con el DNI.
         * Password 123456 para todos.
         *
         * Incluye DOS conjuntos para que el login funcione tanto en un arranque
         * limpio de CentroEducativo como tras ejecutar el script de población:
         *   - DEFECTO: usuarios que trae CentroEducativo al arrancar (enunciado, secc. 6.5).
         *   - SCRIPT : usuarios creados por scripts/poblar-centroeducativo-completo.sh.
         */

    	// ===== Profesorado (rolpro) =====
    	// --- Por defecto (secc. 6.5 del enunciado) ---
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        // Evita que el navegador cachee los recursos protegidos. Sin esto, tras
        // el logout las páginas de /alumno/* y /profesor/* seguirían viéndose
        // desde la caché (al pulsar "atrás") sin volver a pedir autenticación.
